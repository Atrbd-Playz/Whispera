        ...
        <div className="flex items-end justify-center">
            <DropdownMenu>
                <DropdownMenuTrigger asChild>
                    <svg className="cursor-pointer" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#00000" fill="none">
                ...
                <DropdownMenuContent className="w-56">
                    ...
                    <DropdownMenuLabel className="text-[12px] tracking-tighter text-foreground">Settings</DropdownMenuLabel>
